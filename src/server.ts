...
export function makeServer() {
  return createServer({
    routes() {
      this.get('/customers/:customerId/profile', () => ({
        customerId: '12345',
        name: 'John Doe',
      ...
      this.get('/customers/:customerId/spending/summary', () => ({
        period: '30d',
        totalSpent: 4250.75,
        transactionCount: 47,
      ...
      this.get('/customers/:customerId/spending/categories', () => ({
        dateRange: {
      ...
      this.get('/customers/:customerId/spending/trends', () => ({
        trends: [
          {
            month: '2024-01',
            totalSpent: 3890.25,
      ...
      this.get('/customers/:customerId/transactions', () => ({
        transactions: [
          {
            id: 'txn_123456',
      ...
      this.get('/customers/:customerId/goals', () => ({
        goals: [
          {
            id: 'goal_001',
            category: 'Entertainment',
      ...
      this.get('/customers/:customerId/filters', () => ({
        categories: [
